...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $scheduleProgres->schedule_progress_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $scheduleProgres->schedule_progress_id)]
            )
        ?></li>
...
<div class="scheduleProgress form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Schedule Progres') ?></legend>
        <?php
